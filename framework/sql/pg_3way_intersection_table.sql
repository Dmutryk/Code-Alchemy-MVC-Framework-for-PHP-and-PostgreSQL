...
CREATE TABLE __table_name__ (
  ...
  __model3_name___id INTEGER NOT NULL,
    --PLACEHOLDER
  ...
  MATCH SIMPLE ON UPDATE NO ACTION ON DELETE NO ACTION,
  FOREIGN KEY (__model3_name___id) REFERENCES __model3_name__ (__model3_name___id)
  MATCH SIMPLE ON UPDATE NO ACTION ON DELETE NO ACTION,
...
CREATE UNIQUE INDEX fk___table_name___tuplet__ ON __table_name__ USING BTREE (__model1_name___id, __model2_name___id,__model3_name___id);

...
class instagram {
    ...
    public function __construct($config) {
        if (true === is_array($config)) {
            ...
            throw new \Exception("Instagram Error: __construct() - Configuration data is missing.");
        }
    }
    ...
    private function _makeCall($function, $auth = false, $params = null, $method = 'GET') {
        if (false === $auth) {
            ...
            if (true === isset($this->_accesstoken)) {
                ...
                return array('result'=>'error','error'=>'This method requires an authorization token');
            }
        }

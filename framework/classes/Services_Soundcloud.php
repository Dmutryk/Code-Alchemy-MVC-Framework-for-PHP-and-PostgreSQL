...
require_once $codealchemy_location."/classes/Soundcloud/Exception.php";

require_once $codealchemy_location.'/classes/Soundcloud/Version.php';
...
*/
        ...
        if ($this->_validResponseCode($this->_lastHttpResponseCode)) {
            ...
            FB::error("last http response = ".$this->_lastHttpResponseCode);

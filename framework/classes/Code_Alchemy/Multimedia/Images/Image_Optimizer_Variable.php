 ...
 */
class Image_Optimizer_Variable extends Array_Representable_Object {

    public function __construct($directory='website_image'){

        $directory_complete = new Webroot()."/images/".$directory;
        // Get all website images
        $website_images = (new Directory_API( $directory_complete ))
        ...
        // Get save dir
        $website_images_dir = (string) $directory_complete;

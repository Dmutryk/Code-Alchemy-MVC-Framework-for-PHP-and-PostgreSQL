 ...
 */
class Send_Email_Immediately extends Array_Representable_Object{
     ...
     * @param string $sender
     */
    public function __construct( $template_key, array $recipients, array $data, $sender ) {

        $this->array_values = (new Mail_Service_API_Client())

            ->send_immediately($sender,$recipients,$template_key,$data);

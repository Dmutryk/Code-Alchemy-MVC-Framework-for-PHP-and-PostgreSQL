...
class x_object {
    ...
    public function __construct( $key, $attributes = null, $xml=null  ) {
		global $container,$webapp_location, $codealchemy_location;
        ...
        $vfs = array(
            ...
            $codealchemy_location . "views/$key.php",
            $codealchemy_location . "views/pages/$key.php",
        ...
        if ( ! $found)
            throw new ObjectNotInitializedException("$key: No such view file found");

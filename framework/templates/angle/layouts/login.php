                        ...
                        <div id="loginbox" style="display:<?=$modal=='signin'?'':'none'?>;margin-top:50px;display:<?=$controller->uri()->part(1)=='inscribirse'?'none':''?>" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
                            <div class="panel panel-info" >
                                ...
                                <div class="panel-heading">
                                    ...
                                    <div style="float:right; font-size: 80%; position: relative; top:-10px"><a href="#" onClick="$('#loginbox').hide(); $('#forgotbox').show()">forgot your password?</a></div>
                                </div>
                                ...
                                <div style="padding-top:30px" class="panel-body" >
                                    ...
                                    <?php if ( isset( $_REQUEST['reset'])){ ?>
                                        ...
                                        <span>You can use your newly created password to login now</span>
                                    </div>
                                    <?php } ?>
                                    ...
                                    <form id="loginform" class="form-horizontal pull-left" role="form" method="POST" action="/acceder">
                                        ...
                                        <!-- password -->
                                        <div style="margin-bottom: 25px" class="input-group">
                                            <span class="input-group-addon"><i class="fa fa-user-secret"></i>
</span>
                            ...
                            <div class="panel panel-info">
                                ...
                                <div class="panel-body" >
                                    <form id="signupform" class="form-horizontal" role="form" method="POST" action="/inscribirse">
                                        ...
                                        <!-- first name -->
                                        <div class="form-group">
                                            <label for="signup-firstname" class="col-md-4 control-label">First name</label>
                                            <div class="col-md-8">
                                                <input id="signup-firstname" type="text" class="form-control" name="first_name" placeholder="First name">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="signup-lastname" class="col-md-4 control-label">Last name(s)</label>
                                            <div class="col-md-8">
                                                <input id="signup-lastname" type="text" class="form-control" name="last_name" placeholder="Last name(s)">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="signup-password" class="col-md-4 control-label">Password</label>
                                            <div class="col-md-8">
                                                <input id="signup-password" type="password" class="form-control" name="password" placeholder="">
                                            </div>
                                        </div>

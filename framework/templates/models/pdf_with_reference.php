...
class _model_name_ extends \business_object {
    ...
    const datasource =
        "<datasource>
            ...
            <key>id</key>
            <read_only></read_only>
            <required>__reference_model_name___id</required>
            <search></search>
            <related>__reference_model_name__</related>
        </datasource>";
     ...
     */
    public function pdf_filename_url(){

        return "/images/$this->pdf_filename";
    ...
    public function update_from_associative( array $array, $updating_user_id = 0 ){
        ...
        new File_Uploader('pdf_filename','/images/',$array);

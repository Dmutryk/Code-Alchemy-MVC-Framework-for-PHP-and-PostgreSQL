...
class _model_name_ extends \business_object {
    ...
    const datasource =
        "<datasource>
            ...
            <key>id</key>
            <read_only></read_only>
            <required>__referencing___id</required>
            <search></search>
            <related>__referencing__</related>
        </datasource>";

    /**
     * @var string Image root
     */
    private $image_root = '/images/_table_name_/';

    /**
     * @var string Image Root
     */
    private static $image_root_static = '/images/_table_name_/';
     ...
     * @return string Image Filename URL
     */
    public function thumbnail_image_filename_url(){

        return "$this->image_root$this->thumbnail_image_filename";
    ...
    public function update_from_associative( array $array, $updating_user_id = 0 ){
        ...
        // uncomment the below to Handle file upload
        new File_Uploader('thumbnail_image_filename',$this->image_root,$array);
    ...
    public static function create_from_associative( array $array, \xo_loggable $logger = null ){
        ...
        // uncomment the below to Handle file upload
        new File_Uploader('thumbnail_image_filename',self::$image_root_static,$array);

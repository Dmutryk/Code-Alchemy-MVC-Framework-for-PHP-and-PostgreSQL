            ...
            <div id="loginbox" style="margin-top:50px;display:<?=$controller->uri()->part(1)=='inscribirse'?'none':''?>" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
                <div class="panel panel-info" >
                    <div class="panel-heading">
                        ...
                        <div style="float:right; font-size: 80%; position: relative; top:-10px"><a onClick="$('#loginbox').hide(); $('#forgotbox').show()" href="#">Forgot password?</a></div>
                    </div>
                    ...
                    <div style="padding-top:30px" class="panel-body" >
                        ...
                        <?php if ( isset( $_GET['redirect'])){ ?>
                            <div style="" id="login-alert" class="alert alert-info alert-dismissable col-sm-12">You must be logged in to do that</div>
                        <?php } ?>
                        ...
                        <form id="loginform" class="form-horizontal" role="form" method="POST" action="/acceder">
                            ...
                            <input type="hidden" name="login_redirect" value="<?=@$_GET['redirect']?>">
                        </form>
...
function get_controller( \antonia\controllers\app_controller $controller ){

    return $controller;
}

/**
 * @param \antonia\controllers\app_controller $controller
 * @return \antonia\components\state
 */
function get_state( \antonia\controllers\app_controller $controller ){

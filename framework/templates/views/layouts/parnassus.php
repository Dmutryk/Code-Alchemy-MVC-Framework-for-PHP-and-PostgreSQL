                ...
                success: function(data){
                    ...
                    $.each(data,function(index,item){
                        ...
                        $(position).append('<div style="text-decoration:'+
                            ...
                            '"></i><i style="cursor:pointer" class="'+(item.is_hidden?'is-hidden':'')+' pull-right fa '+(item.is_hidden?'fa-eye':'fa-times')+' remove-service" data-service-name="'+item.table_name+'"></i></h3></div><div class="panel-body"><a href="/parnassus/list_of/'+item.table_name+'/1/25">Click to manage: <span class="badge">'+item.count_models+'</span></a></div></div>');
